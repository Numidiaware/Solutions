...
// PC Control Suite Pages
import PCControlSuiteLayout from './pages/product/PCControlSuite/Layout';
import PCDocumentation from './pages/product/PCControlSuite/Documentation';
import PCDownload from './pages/product/PCControlSuite/Download';
import PCReleaseHistory from './pages/product/PCControlSuite/ReleaseHistory';
import PCSupport from './pages/product/PCControlSuite/Support';
import PCLicense from './pages/product/PCControlSuite/License';
...
const App: React.FC = () => {
  ...
  } else if (normalizedRoute.startsWith('/products/pc-control-suite')) {
    // Nested routing for PC Control Suite
    const subRoute = normalizedRoute.replace('/products/pc-control-suite', '');
    let subComponent;
    
    if (subRoute.includes('/docs')) {
      subComponent = <PCDocumentation />;
    } else if (subRoute.includes('/download')) {
      subComponent = <PCDownload />;
    } else if (subRoute.includes('/history')) {
      subComponent = <PCReleaseHistory />;
    } else if (subRoute.includes('/support')) {
      subComponent = <PCSupport />;
    } else if (subRoute.includes('/license')) {
      subComponent = <PCLicense />;
    } else {
      subComponent = <PCDocumentation />;
    }
    
    pageContent = <PCControlSuiteLayout>{subComponent}</PCControlSuiteLayout>;
  } else {
    // 404 Fallback
    pageContent = <Home />;
  }
