...
import PCControlSuiteIcon from './PCControlSuiteIcon';
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            >
              ...
              >
                ...
                >
                  <div className="text-brand-600 dark:text-brand-400 p-2 rounded-md transition-colors">
                ...
                >
                  <div className="text-brand-600 dark:text-brand-400 p-2 rounded-md transition-colors">
                    <PCControlSuiteIcon size={24} />
                  </div>
                  <div>
                    <div className="font-semibold text-slate-800 dark:text-slate-100">PC Control Suite</div>
                    <div className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Comprehensive suite for PC management and automation.</div>
                  </div>
                </Link>
              </div>
            </div>
