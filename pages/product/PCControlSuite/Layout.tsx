      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center gap-4 mb-8">
           <div className="bg-white dark:bg-slate-900 p-3 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800">
             <PCControlSuiteIcon size={48} />
           </div>
           <div>
             <h1 className="text-3xl font-bold text-slate-900 dark:text-white">PC Control Suite</h1>
             <p className="text-slate-500 dark:text-slate-400">Comprehensive suite for PC management and automation</p>
           </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-t-xl border-b border-slate-200 dark:border-slate-800 shadow-sm overflow-x-auto transition-colors duration-200">
          <div className="flex">
            {tabs.map((tab) => (
              <Link
                key={tab.path}
                href={`#/products/pc-control-suite/${tab.path}`}
